...
from models import KnowledgePrompting
...
def train(
    ...
    kgp_model = KnowledgePrompting(model, kge_model=kge_model, adapter_type=adapter_type)

    if data_path.endswith(".json") or data_path.endswith(".jsonl"):
        data = load_dataset("json", data_files=data_path, cache_dir="./")
    else:
        data = load_dataset(data_path, cache_dir="./")
    ...
    torch.save(kgp_model.embeddings, os.path.join(output_dir, "embeddings-final.pth"))
